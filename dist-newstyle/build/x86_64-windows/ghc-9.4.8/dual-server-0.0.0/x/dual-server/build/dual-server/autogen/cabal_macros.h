...
/* package dual-server-0.0.0 */
#ifndef VERSION_dual_server
#define VERSION_dual_server "0.0.0"
#endif /* VERSION_dual_server */
#ifndef MIN_VERSION_dual_server
#define MIN_VERSION_dual_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_dual_server */
...
#define CURRENT_COMPONENT_ID "dual-server-0.0.0-inplace-dual-server"
